...
// // Placeholder logo (replace with actual logo paths)
...
//   return (
//     <motion.div
//       className="relative w-40 h-20 md:w-48 md:h-24 flex items-center justify-center"
//       variants={variants}
//       initial="hidden"
...
//       }}
//     >
//       <div className="relative transition-all duration-500 hover:shadow-[0_0_20px_rgba(0,161,214,0.5)] rounded-lg">
//         <Image
//           src={logoSrc || placeholderLogo}
//           alt={alt}
//           width={192}
//           height={96}
//           className="w-full h-full object-contain bg-gray-300 p-2 rounded-lg"
//           priority={true}
//         />
//         {/* Pulsing glow effect on hover */}
//         <motion.div
//           className="absolute inset-0 rounded-lg border border-[rgba(0,161,214,0.5)] opacity-0"
//           initial={{ opacity: 0 }}
//           whileHover={{
//             opacity: 1,
//             transition: {
